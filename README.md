# Команды для работы
  Чтобы запустить unit тесты достаточно написать
```npm
npm run test
```
  Чтобы запустить интеграционные тесты достаточно написать
```npm
npm run herm
```
  Чтобы запустить перезапись статитики для интеграционных тестов достаточно написать
```
npm run herm:update
```
